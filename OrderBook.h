...
class OrderBook {
public:
    std::map<std::string, std::priority_queue<std::shared_ptr<Order>, std::vector<std::shared_ptr<Order>>, CompareOrder>> buyOrders;
    std::map<std::string, std::priority_queue<std::shared_ptr<Order>, std::vector<std::shared_ptr<Order>>, CompareSellOrder>> sellOrders;
    OrderBook();
